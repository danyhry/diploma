...
<p>The super admin is the only user who can add users to the org because it impacts the monthly bill. The super admin will use the website to manage membership. Every org has a <code class="language-text">developers</code> team that all users are automatically added to.</p>
